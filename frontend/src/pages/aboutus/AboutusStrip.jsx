      ...
      <div>
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="md:col-span-3  flex flex-col gap-8">
            ...
            <button className="mt-6 px-4 self-center md:self-auto py-2 w-44 rounded-lg bg-brandLightMaroon hover:bg-brandDarkMaroon transition-all duration-200 text-white shadow-lg">
              DISCOVER MORE
            </button>
          </div>
        </div>
